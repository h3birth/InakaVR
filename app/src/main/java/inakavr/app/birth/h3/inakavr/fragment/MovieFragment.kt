...
import inakavr.app.birth.h3.inakavr.adapter.MovieItemRecyclerViewAdapter
...
//                }
//                adapter = MovieItemRecyclerViewAdapter(resources.getStringArray(R.array.panorama_movie_list).toMutableList(), listener)
//            }
//        }
        return view
    }
        ...
        try {
            ...
            retrofit.create(YoutubeDataApiService::class.java)
                    ...
                    .subscribe({apiresponse ->
                                ...
                                // Set the adapter
                                movie_list.adapter = MovieItemRecyclerViewAdapter(apiresponse.items.toMutableList(), listener)
